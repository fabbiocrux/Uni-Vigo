...
Fase.I %>% select(Material:Load.max,Young ) %>% 
   set_names("Material", "Layer Height (mm)", "Infill Pattern", "Infill Density (%)", "Printing Speed (mm/s)", "Max Load (kN)", "Young Modulus (kN)" )

table.fase1$`Max Load (kN)` <- table.fase1$`Max Load (kN)` %>% round( digits=2)
table.fase1$`Young Modulus (kN)` <- table.fase1$`Young Modulus (kN)` %>% round( digits=2)
